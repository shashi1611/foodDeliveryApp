...
public class addProductSoup extends AppCompatActivity {
    Toolbar toolbarSoup;
...
//    RadioGroup group;
    ...
    protected void onStart() {
        ...
        if (user == null) {
            Intent intent = new Intent(addProductSoup.this, authentication.class);
            finish();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_product_soup);
//        setContentView(R.layout.activity_add_product_biryani);
//        toolbarSoup=findViewById(R.id.toolbarCustomSoup);
//        setSupportActionBar(toolbarSoup);
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        addProductButton=findViewById(R.id.addProductSoupButton);

        img=findViewById(R.id.addProductSoupImage);
        tn=findViewById(R.id.addProductSoupName);
        td=findViewById(R.id.addProductSoupDescription);
        tp=findViewById(R.id.addProductSoupPrice);
//        btnf=findViewById(R.id.addProductSoupFplate);
//        btnh=findViewById(R.id.addProductSouphplate);
        tincrement=findViewById(R.id.addProductSoupIncrement);
        tdecrement=findViewById(R.id.addProductSoupDecrement);
        tcount=findViewById(R.id.addProductSoupCount);
//        group=findViewById(R.id.radioGroupSoup);
        //  <-----------------------------------------------------------------dialog declaration------------------------------------------------------------------->
...
//        btnh.setText(halfPlatePrice);
        ...
        tdecrement.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(addProductSoup.this, "the item is discarded", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//                            startActivity(intent);
//                            finish();
                        Toast.makeText(addProductSoup.this, "added successfully", Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(addProductSoup.this, "the error is"+e, Toast.LENGTH_SHORT).show();
                    }
                });

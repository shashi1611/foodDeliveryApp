...
public class addProductIceCream extends AppCompatActivity {
    Toolbar toolbarIceCream;
...
//    RadioGroup group;
    ...
    protected void onStart() {
        ...
        if (user == null) {
            Intent intent = new Intent(addProductIceCream.this, authentication.class);
            finish();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_product_ice_cream);
//        setContentView(R.layout.activity_add_product_biryani);
//        toolbarIceCream=findViewById(R.id.toolbarCustomIceCream);
//        setSupportActionBar(toolbarIceCream);
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        addProductButton=findViewById(R.id.addProductIceCreamButton);

        img=findViewById(R.id.addProductIceCreamImage);
        tn=findViewById(R.id.addProductIceCreamName);
        td=findViewById(R.id.addProductIceCreamDescription);
        tp=findViewById(R.id.addProductIceCreamPrice);
//        btnf=findViewById(R.id.addProductIceCreamFplate);
//        btnh=findViewById(R.id.addProductIceCreamhplate);
        tincrement=findViewById(R.id.addProductIceCreamIncrement);
        tdecrement=findViewById(R.id.addProductIceCreamDecrement);
        tcount=findViewById(R.id.addProductIceCreamCount);
//        group=findViewById(R.id.radioGroupIceCream);
//          <-----------------------------------------------------------------dialog declaration------------------------------------------------------------------->
...
//        btnh.setText(halfPlatePrice);
        ...
        tdecrement.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(addProductIceCream.this, "the item is discarded", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//                            finish();
                        dialog1.dismiss();
                        Toast.makeText(addProductIceCream.this, "added successfully", Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(addProductIceCream.this, "the error is"+e, Toast.LENGTH_SHORT).show();
                    }
                });

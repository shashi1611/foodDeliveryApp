...
import com.restaurant.fooddeliveryapp.addProductChinese;
import com.restaurant.fooddeliveryapp.models.modelChinese;

import java.util.List;

//public class adapterChinese {
//}
public class adapterChinese extends RecyclerView.Adapter<adapterChinese.MyViewHolder> {
    Context context;
    List<modelChinese> list;
    public adapterChinese(Context cont,List<modelChinese>li)
    {
        this.context=cont;
        this.list=li;
    }
    ...
    @Override
    public adapterChinese.MyViewHolder onCreateViewHolder(@NonNull @org.jetbrains.annotations.NotNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.single_item_all_product,parent,false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull @org.jetbrains.annotations.NotNull adapterChinese.MyViewHolder holder, int position) {
        modelChinese m=list.get(position);
...
//        holder.text2.setText(list.get(position).getLoc());
        ...
        holder.btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent intent=new Intent(context, addProductChinese.class);

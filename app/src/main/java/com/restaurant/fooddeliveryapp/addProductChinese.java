...
public class addProductChinese extends AppCompatActivity {
    Toolbar toolbarChinese;
...
//    String price;
    ...
    protected void onStart() {
        ...
        if (user == null) {
            Intent intent = new Intent(addProductChinese.this, authentication.class);
            finish();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_product_chinese);
//        setContentView(R.layout.activity_add_product_biryani);
//        toolbarChinese=findViewById(R.id.toolbarCustomChinese);
//        setSupportActionBar(toolbarChinese);
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        addProductButton=findViewById(R.id.addProductChineseButton);

        img=findViewById(R.id.addProductChineseImage);
        tn=findViewById(R.id.addProductChineseName);
        td=findViewById(R.id.addProductChineseDescription);
        tp=findViewById(R.id.addProductChinesePrice);
//        btnf=findViewById(R.id.addProductChineseFplate);
//        btnh=findViewById(R.id.addProductChinesehplate);
        tincrement=findViewById(R.id.addProductChineseIncrement);
        tdecrement=findViewById(R.id.addProductChineseDecrement);
        tcount=findViewById(R.id.addProductChineseCount);
//        group=findViewById(R.id.radioGroupChinese);
        //  <-----------------------------------------------------------------dialog declaration------------------------------------------------------------------->
...
//        btnh.setText(halfPlatePrice);
        ...
        tdecrement.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(addProductChinese.this, "the item is discarded", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//                            finish();
                        dialog1.dismiss();
                        Toast.makeText(addProductChinese.this, "added successfully", Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(addProductChinese.this, "the error is"+e, Toast.LENGTH_SHORT).show();
                    }
                });
